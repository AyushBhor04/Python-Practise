...
# Q7.Given a string:"Apna College"
# Print characters from index 1 to 4 using slicing.
# str = "Apna College"
# print(str[1:5]) 

# Q8.Given a string:# "Programming"
# Print everything from index 3 to the end.
# str = "Programming"
# print(str[3:len(str)])  

# Q9.Given a string: "HelloWorld"
# Print the last 3 characters using negative slicing.
# str="Helloworld" 
# print(str[-3:len(str)])

#Q10. Write a program to check if a string ends with a given word.
# str="Hello Ayush"
# print(str.endswith("Ayus")) 
# print(str.endswith("Ayush")) 

# Q11.Take a string and: # capitalize it  # Replace all occurrences of "a" with "o" in a string.
...
#HARD
# Q12.Take the user’s name as input and print the length of the name.
# str=input("Enter your name : ")
# print(str)
# print(len(str)) 

# Q13.Given a string:"I love Python programming"
# Find the index of the word "Python".
# str="I love Python programming"
# print(str.find("Python"))

# Q14.Write a program to count the number of times "@" appears in a string.
# str="@@ayush@@"
# print(str.count("@")) 

# Q15.Write a program that takes a string and prints: first 3 characters , last 3 characters .
# str=input("Enter a string : ") 
# print(str[0:3])
# print(str[-3:len(str)]) 

# Q16.Write a program to check whether a given character exists in a string using .find().
# str="Ayush"
# print(str.find("A")) 

#Q17. Create a variable light and: # print "Stop" if red # print "Look" if yellow # print "Go" if green
...
# Q18.Take a number from the user and check whether it is: # greater than 10 or less than or equal to 10
...
# Q19.Take a number and check whether it is positive or negative.
# num=int(input("Enter any number : ")) 
# if(num>0):
#     print("Positive") 
# else:
...
# Q20.Take two numbers and print which one is greater.
...
# Q21.Take a string and count how many times a specific character appears (user input).
# str=input("Enter any string : ")
# val=input("ENter the character to be checked : ")
# print(str.count(val)) 

# Q22.Take a string and replace all spaces with underscores _.
# str=input("Enter any string : ")
# print(str.replace(" ","_"))  
